...
Feel free to edit (by clicking <i class="fa fa-edit"></i> on the nav bar) the work if you see some error. Also,  modifying and resharing the work is welcomed. For more information, about improving the work, see the License section below.
